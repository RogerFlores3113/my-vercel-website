import { BoringClient, JokeCard, CalendarWidget, ComingSoonLink } from './BoringClient'
      ...
      <header className="rail">
        <div className="rail-inner">
          ...
          <nav>
            ...
            <a className="gameback" href="https://rogerflores.dev/" title="Go to the game version">
